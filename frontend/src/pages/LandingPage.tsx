...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 overflow-y-auto overflow-x-hidden fixed inset-0">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-700 z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              <img src="/images/logos/logo.webp" alt="Podly" className="h-8 w-auto" />
              <span className="text-xl font-bold text-gray-900 dark:text-white">Podly</span>
            </div>
      ...
      <section className="pt-32 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Live user count */}
          <div className="inline-flex items-center gap-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-6 py-4 shadow-sm mb-8">
            <div className="flex items-center gap-2">
              <div className="h-2 w-2 rounded-full bg-green-500 animate-pulse" />
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                {userLimit !== null && userLimit !== undefined && userLimit > 0 ? (
                  <>
                    <strong className="text-gray-900 dark:text-white">{userCount}</strong> / {userLimit} testers
                  ...
                  <>
                    <strong className="text-gray-900 dark:text-white">{userCount}</strong> active testers
                  </>
                )}
              </span>
            </div>
          ...
          {slotsRemaining !== null && slotsRemaining === 0 && (
            <div className="max-w-2xl mx-auto bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-4 text-sm text-amber-900 dark:text-amber-300">
      ...
      <section id="how-it-works" className="pt-12 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">Podly grabs the feed, finds sponsorship blocks, and gives you a private RSS link so your own players stream the ad-free version.</p>
          </div>
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
              <p className="text-sm font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400 mb-4">Listen anywhere</p>
              <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                <li><strong className="text-gray-900 dark:text-white">Apple Podcasts:</strong> Library → Edit → Add Show by URL → paste the Podly link.</li>
                <li><strong className="text-gray-900 dark:text-white">Overcast:</strong> Tap + → Add URL → paste → done.</li>
                <li><strong className="text-gray-900 dark:text-white">Pocket Casts:</strong> Discover → Paste RSS Link → Subscribe.</li>
                <li><strong className="text-gray-900 dark:text-white">Other players:</strong> Podcast Addict, AntennaPod, Castro, etc. all support "add via URL."</li>
              </ul>
              <div className="mt-4 rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50/70 dark:bg-amber-900/20 p-3 text-sm text-amber-900 dark:text-amber-300">
                Spotify blocks custom RSS feeds, so switch to any other podcast app when you use Podly links.
              </div>
            </div>
            <div className="rounded-2xl border border-blue-100 dark:border-blue-800 bg-blue-50/60 dark:bg-blue-900/20 p-6">
              <p className="text-sm font-semibold uppercase tracking-wide text-blue-900 dark:text-blue-300 mb-4">Getting started</p>
              <ol className="space-y-3 text-sm text-blue-900/90 dark:text-blue-300/90">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-gray-900 dark:text-white">Podly</span>
            </div>
