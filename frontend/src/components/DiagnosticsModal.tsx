...
const GITHUB_NEW_ISSUE_URL = 'https://github.com/2fst4u/podly_pure_podcasts/issues/new';
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-3xl bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg overflow-hidden">
        <div className="flex items-start justify-between gap-4 px-5 py-4 border-b border-gray-200 dark:border-gray-700">
          <div>
            <h2 className="text-base font-semibold text-gray-900 dark:text-white">Troubleshooting</h2>
          ...
          <button
            type="button"
            onClick={close}
            className="px-3 py-1.5 text-sm border border-gray-200 dark:border-gray-700 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
          >
            Dismiss
          </button>
        </div>
        ...
        {currentError && (
          <div className="px-5 py-4 border-b border-gray-200 dark:border-gray-700 bg-red-50 dark:bg-red-900/20">
            <div className="text-sm font-medium text-red-900 dark:text-red-300">{currentError.title}</div>
        ...
        <div className="px-5 py-4">
          <div className="flex flex-col sm:flex-row gap-2 sm:items-center sm:justify-between mb-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="inline-flex items-center justify-center px-3 py-2 rounded-md border border-gray-200 dark:border-gray-700 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                Copy logs
              </button>
              <button
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-md bg-gray-50 dark:bg-gray-900 overflow-hidden">
            <div className="max-h-[45vh] overflow-auto">
              <pre className="text-xs text-gray-800 dark:text-gray-100 p-3 whitespace-pre-wrap break-words">
{recentEntries
  .map((e) => {
